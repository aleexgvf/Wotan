...
//// Validacion de Contraseñas y Email///////////////////////////////////
...
{
    //Necesita contener -->  1 num /  1 Minuscula/ 1 Mayuscula/ 1 Special / 6 Caracteres como minimo
    val passwordPattern = "^(?=.*[0-9]) (?=.*[a-z]) (?=.*[A-Z]) (?=.*[@#\$%^&+=]) (?=\\\\S+\$).{6,}\$" //"^(?=.*[0-9])(?=.+*[A-Z])(?=.*[@#$%^&+=!])(?=\\s+$)-{4,}"
